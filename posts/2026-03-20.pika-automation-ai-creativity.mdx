...
description: >-
  How building Pika taught me that automation isn't the enemy of creativity -
  it's the thing that clears the path back to it.
tags:
  - pika
  - automation
  - ai
...
I built [Pika](https://superhighfives.com/pika) because I was tired of context-switching. Picking a color off the screen shouldn't require opening a whole application, navigating a UI, and then copying a hex value. It should be instant.

So I made it instant.

## The thing about tools

There's a version of this story where I talk about Pika's features - the WCAG contrast checking, the color name lookup, the keyboard shortcuts, the Raycast integration. And those things are genuinely useful. But that's not the interesting part.
