...
visual:
  prompt: >-
    Bold geometric dot patterns forming clear terminal windows and command
    prompt shapes, high contrast with bright coral and orange dots on solid
    black background, clean lines, pop art style, t-shirt design
  image:
  ...
  video:
    ...
    guidance: >-
      no text, no words, no language, animate the dots out of frame, kinetic
      movement
  colors:
    - text: '#ff5030'
      background: '#020203'
