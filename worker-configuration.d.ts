/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3182c32029ecbe9376631714623a579b)
// Runtime types generated with workerd@1.20250617.0 2025-04-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare" | "Hello from Cloudflare (Staging)";
		KUDOS_DO: DurableObjectNamespace /* KudosObject from code */;
		ASSETS: Fetcher;
	}
}
