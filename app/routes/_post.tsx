...
export default function Post() {
  ...
  return (
    <div className="grid gap-y-4">
      ...
      <div className="prose prose-headings:text-sm prose-sm dark:prose-invert prose-a:text-indigo-600 hover:prose-a:text-indigo-500 dark:prose-a:text-indigo-400 dark:hover:prose-a:text-indigo-300 prose-a:no-underline py-3 sm:px-4 border border-transparent max-w-none [&>*:not(.code)]:max-w-[60ch] [&>.code]:overflow-x-scroll [&>.code]:max-w-[calc(100vw)] [&>.code]:-mx-8 sm:[&>.code]:-mx-12 [&>.code_code>*]:px-8 sm:[&>.code_code>*]:px-12 [&>.code]:border-y [&>.code]:py-8 [&>.code]:dark:border-gray-900 [&>.code]:dark:bg-black [&>.code]:bg-gray-50 prose-h1:before:content-['#'] prose-h2:before:content-['##'] prose-h3:before:content-['###'] prose-h4:before:content-['####'] prose-h5:before:content-['#####'] prose-h6:before:content-['######'] prose-headings:before:mr-2 prose-headings:before:tracking-widest prose-headings:before:text-indigo-400 prose-h1:border-b-2 prose-h2:border-b prose-h3:border-b prose-h1:border-indigo-400 prose-h2:border-indigo-400/80 prose-h3:border-indigo-400/60 prose-headings:pb-4 prose-headings:mb-4 prose-h3:inline-block">
        <Outlet />
      </div>
