/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d08130c1d16d5e0a3dd158d92555c596)
// Runtime types generated with workerd@1.20260616.1 2025-04-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	VISUAL_ASSETS: R2Bucket;
	ASSETS: Fetcher;
	VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare (Staging)" | "Hello from Cloudflare";
	REPLICATE_API_TOKEN: string;
	KUDOS_DO: DurableObjectNamespace /* KudosObject from code-staging */ | DurableObjectNamespace /* KudosObject from code */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "KudosObject";
	}
	interface StagingEnv {
		...
		REPLICATE_API_TOKEN: string;
		KUDOS_DO: DurableObjectNamespace /* KudosObject from code-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "REPLICATE_API_TOKEN">> {}
}
