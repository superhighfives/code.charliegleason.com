...
The meta string gets parsed by `parseMetaString` in `app/mdx/mdx-hooks.tsx`, and the value is passed through to the CSS as an inline `max-width` on the figure.
