...
description: >-
  How to open-source a public Remix site while keeping some routes authenticated
  and private on Cloudflare.
tags:
  - remix
  - cloudflare
  - deployment
visual:
  prompt: A collection of different locks and keys
  image:
