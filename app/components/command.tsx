...
export default function Command({
  ...
  return (
    <div className="relative border p-4 pr-16 rounded-xs bg-gray-50 dark:bg-gray-950 border-gray-200 dark:border-gray-700 mt-4 break-all [&_pre_code]:whitespace-pre-wrap">
      <div
