...
description: How to open-source a public Remix site while keeping some routes authenticated and private.
image: true
links:
...
<Diagram src="public-private-remix-diagram.svg" alt="A diagram showing the public / private repo setup and deployment target" />
